	...
	*/
	class category
	{
		...
		public function insert_category($catName){
			...
			if(empty($catName)){
				$alert = "<span class='error'>Vui lòng điền đầy đủ vào ô!..</span>";
				return $alert;
			}else{
		...
		public function update_category($catName,$id)
		{
			...
			if(empty($catName)){
				$alert = "<span class='error'>Danh mục sản phẩm trống.</span>";
				return $alert;
			}else{
				...
				if($result){
					...
					$alert = "<span class='error'>cập nhật danh mục bị lỗi:))</span>";
					return $alert;
				}
			}
