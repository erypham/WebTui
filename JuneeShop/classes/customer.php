	...
	class customer
	{
		...
		public function insert_customer($date)
		{
			...
			if($name == "" || $city == "" || $zipcode == "" || $email == "" || $address == "" || $country == "" || $phone == "" || $password == ""){
				$alert = "<span class='error'>Không được để trống ạ.</span>";
				return $alert;
			}else{
				...
				if ($result_check) {
					...
					if($result){
						...
						$alert = "<span class='error'>Đăng ký hàng thất bại</span>";
						return $alert;
					}
				}
			}
		...
		public function update_customers($data, $id)
		{
			...
			if($name=="" || $zipcode=="" || $email=="" || $address=="" || $phone ==""){
				$alert = "<span class='error'>Hông được để trống..</span>";
				return $alert;
			}else{
				...
				if($result){
						...
						$alert = "<span class='error'>Khách hàng cập nhật thất bại.</span>";
						return $alert;
				}
