...
<?php 
 ...
 <style type="text/css">
	...
	.a_order {
    background: -webkit-gradient(linear,left top,left bottom,from(#24f5f5),to(#161d14));
    color: aliceblue;
    padding: 10px;
    font-size: 25px;
    border-radius: 2rem;
...
<form action="" method="POST">
 <div class="main">
    <div class="content">
 	...
 	<center style="padding-bottom: 20px;"><a href="?orderid=order" class="a_order">Thanh Toán Ngay</a></center>
 </div>
</form>
<?php 
